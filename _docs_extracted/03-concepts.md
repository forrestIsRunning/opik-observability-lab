If you want to jump straight to logging traces, you can head to the [Log traces](https://www.comet.com/docs/opik/tracing/advanced/log_traces) or [Log agents](https://www.comet.com/docs/opik/tracing/advanced/log_traces) guides.
...
- [Log traces](https://www.comet.com/docs/opik/tracing/advanced/log_traces) - Learn how to capture traces in your applications
- [Log agents](https://www.comet.com/docs/opik/tracing/advanced/log_traces) - Understand how to trace agent-based applications
- [Annotate traces](https://www.comet.com/docs/opik/tracing/advanced/annotate_traces) - Add custom metadata to your traces
- [Cost tracking](https://www.comet.com/docs/opik/tracing/advanced/cost_tracking) - Monitor and analyze costs

### Evaluation and Testing:

- [Evaluation concepts](https://www.comet.com/docs/opik/evaluation/concepts) - Deep dive into evaluation concepts
- [Evaluate prompts](https://www.comet.com/docs/opik/v1/evaluation/evaluate_prompt) - Test and compare different prompts
- [Evaluate agents](https://www.comet.com/docs/opik/evaluation/evaluate_agents) - Evaluate complex agent systems
- [Metrics overview](https://www.comet.com/docs/opik/evaluation/metrics/overview) - Available evaluation metrics

### Optimization:

- [Agent Optimization concepts](https://www.comet.com/docs/opik/development/optimization-runs/optimization/concepts) - Core optimization concepts
- [Optimization algorithms](https://www.comet.com/docs/opik/development/optimization-runs/overview) - Available optimization strategies
- [Best practices](https://www.comet.com/docs/opik/development/optimization-runs/overview) - Optimization best practices

### Integration Guides:

- [SDK Configuration](https://www.comet.com/docs/opik/tracing/advanced/sdk_configuration) - Configure Opik in your applications
- [Supported Models](https://www.comet.com/docs/opik/tracing/advanced/cost_tracking) - Models compatible with Opik
- [Integrations](https://www.comet.com/docs/opik/integrations/overview) - Framework-specific integration guides
...
[^1]: [1](https://www.comet.com/docs/opik/tracing/concepts#1-start-with-clear-trace-boundaries)

### 1\. Start with Clear Trace Boundaries

Define clear boundaries for what constitutes a single trace. Typically, this should align with a complete user interaction or business operation.

[^2]: [2](https://www.comet.com/docs/opik/tracing/concepts#2-use-meaningful-span-names)

### 2\. Use Meaningful Span Names

Choose descriptive names for your spans that clearly indicate what operation is being performed. This makes debugging much easier.

[^3]: [3](https://www.comet.com/docs/opik/tracing/concepts#3-leverage-thread-ids-for-conversations)

### 3\. Leverage Thread IDs for Conversations

Use consistent thread IDs for related interactions. This is especially important for chat applications and multi-step workflows.

[^5]: [5](https://www.comet.com/docs/opik/tracing/concepts#5-monitor-performance-continuously)

### 5\. Monitor Performance Continuously

Set up alerts and dashboards to monitor trace performance, error rates, and costs. This helps you catch issues early.

[^6]: [6](https://www.comet.com/docs/opik/tracing/concepts#6-use-traces-for-optimization)
